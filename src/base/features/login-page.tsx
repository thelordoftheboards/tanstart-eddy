...
import { ApplicationIcon } from '~/base-config/components/application-icon';
...
export function LoginPage() {
  const { redirectUrl } = useRouteContext({ from: '/(auth-pages)/login' });
          ...
          <div className="flex flex-col items-center gap-2">
            <a className="flex flex-col items-center gap-2 font-medium" href="#">
              <div className="flex h-8 w-8 items-center justify-center rounded-md">
                <ApplicationIcon className="size-6" />
              </div>
              <span className="sr-only">{serviceHumanReadableName}</span>
            </a>
            <h1 className="font-bold text-xl">Welcome back to {serviceHumanReadableName}</h1>
          </div>
